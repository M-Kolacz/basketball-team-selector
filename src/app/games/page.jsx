...
export default function GamesPage() {
    return __awaiter(this, void 0, void 0, function () {
        var _a, gameSessions, currentUser, players, isAdmin;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _a = _b.sent(), gameSessions = _a[0], currentUser = _a[1], players = _a[2];
			...
			<GameHistory players={players} gameSessions={gameSessions} isAdmin={isAdmin}/>
		</main>)];
            }
        });
    });
