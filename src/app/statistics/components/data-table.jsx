...
export var DataTable = function (_a) {
    ...
    return (<div>
			<div className="flex items-center gap-6 py-4">
				<Input placeholder="Filter players..." value={(_c = (_b = table.getColumn('name')) === null || _b === void 0 ? void 0 : _b.getFilterValue()) !== null && _c !== void 0 ? _c : ''} onChange={function (event) {
            var _a;
            console.log(event.target.value);
            (_a = table.getColumn('name')) === null || _a === void 0 ? void 0 : _a.setFilterValue(event.target.value);
        }} className="max-w-sm"/>
				<DropdownMenu>
