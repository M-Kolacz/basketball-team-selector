...
var SidebarProvider = function (_a) {
    ...
    return (<SidebarContext.Provider value={contextValue}>
			<TooltipProvider delayDuration={0}>
				<div data-slot="sidebar-wrapper" style={__assign({ '--sidebar-width': SIDEBAR_WIDTH, '--sidebar-width-icon': SIDEBAR_WIDTH_ICON }, style)} className={cn('group/sidebar-wrapper flex min-h-svh w-full has-data-[variant=inset]:bg-sidebar', className)} {...props}>
					{children}
				</div>
			</TooltipProvider>
...
var SidebarTrigger = function (_a) {
...
var SidebarSeparator = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
...
var SidebarGroup = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return <div data-slot="sidebar-group" data-sidebar="group" className={cn('relative flex w-full min-w-0 flex-col p-2', className)} {...props}/>;
};
var SidebarGroupLabel = function (_a) {
...
var SidebarGroupAction = function (_a) {
    var className = _a.className, _b = _a.asChild, asChild = _b === void 0 ? false : _b, props = __rest(_a, ["className", "asChild"]);
...
var SidebarGroupContent = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
...
var SidebarMenuButton = function (_a) {
...
var SidebarMenuAction = function (_a) {
...
var SidebarMenuBadge = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
...
var SidebarMenuSkeleton = function (_a) {
...
var SidebarMenuSub = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
...
var SidebarMenuSubItem = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return <li data-slot="sidebar-menu-sub-item" data-sidebar="menu-sub-item" className={cn('group/menu-sub-item relative', className)} {...props}/>;
};
var SidebarMenuSubButton = function (_a) {
